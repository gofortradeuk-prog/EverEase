          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              <button
                ...
                onClick={() => {
                  speakText('Navigating to join EverEase membership');
              ...
              <button
                ...
                onClick={() => {
                  speakText('Navigating to speak with our UK team');
                  navigate('/contact');
                }}
        ...
        <div className="bg-teal-700 text-white rounded-3xl p-8 sm:p-12 text-center space-y-6 shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <button
              type="button"
              onClick={() => {
                speakText('Navigating to pricing plans');
                navigate('/pricing');
              }}
            ...
            <button
              type="button"
              onClick={() => {
                speakText('Navigating to contact page');
                navigate('/contact');
              }}

          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
              <button
                ...
                onClick={() => {
                  speakText('Opening Get Started and membership onboarding');
              ...
              <button
                ...
                onClick={() => {
                  speakText('Navigating to book a free introductory telephone call');
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() => {
                  speakText('Opening Scam Protection module details');
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() => {
                  speakText('Opening Digital Learning module details');
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() => {
                  speakText('Opening Encrypted Document Vault details');
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() => {
                  speakText('Opening Life Reminders details');
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() => {
                  speakText('Opening Home Manager details');
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() => {
                  speakText('Opening Family Connect details');
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => {
                    speakText(`Exploring ${item.title}`);
              ...
              >
                ...
                <div className="pt-4 border-t border-slate-100">
                  <button
                    type="button"
                    onClick={() => {
                      speakText(`Exploring onboarding for ${segment.title}`);
                      navigate('/auth?mode=signup');
                    }}
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-200/80">
                  <button
                    type="button"
                    onClick={() => {
                      speakText(`Learn more about ${module.title}`);
                      navigate('/services');
                    }}
      ...
      <section className="py-16 sm:py-20 px-4 max-w-4xl mx-auto text-center space-y-6" id="home-pre-footer">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <button
            ...
            onClick={() => {
              speakText('Opening membership onboarding');
              navigate('/auth?mode=signup');
            }}

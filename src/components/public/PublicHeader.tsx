        ...
        <div className="w-full max-w-[1500px] mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <button
              ...
              onClick={toggleVoice}
              className={`hidden md:flex items-center gap-1 px-2.5 py-0.5 rounded-md text-xs font-medium border transition-colors ${
                voiceEnabled
                  ? 'bg-emerald-600 text-white border-emerald-500'
                  : 'bg-slate-800 text-slate-300 border-slate-700 hover:bg-slate-700'
              }`}
              title="Toggle Read Aloud Speech Feedback"
            >
              {voiceEnabled ? <Volume2 className="w-3.5 h-3.5" /> : <VolumeX className="w-3.5 h-3.5" />}
              <span>{voiceEnabled ? 'Voice: On' : 'Read Aloud'}</span>
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="hidden sm:flex items-center gap-2.5">
          {currentUser ? (
            <button
              ...
              onClick={() => {
                speakText('Opening your member dashboard');
                navigate('/dashboard');
              }}
            ...
            <>
              <button
                ...
                id="btn-nav-login"
                onClick={() => {
                  speakText('Opening Member Log In');
              ...
              <button
                ...
                id="btn-nav-join-now"
                onClick={() => {
                  speakText('Opening Join Now and membership onboarding');
